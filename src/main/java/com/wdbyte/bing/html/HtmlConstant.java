...
public class HtmlConstant {
    ...
    public static class ImgCard {
        ...
        private static final String VAR_IMG_CARD_DESC = "${img_card_desc}";
        ...
        private static final String IMG_CARD = ""
            ...
            + " <p>${img_card_date} <a href=\"${img_card_download_url}\" class=\"bing-download\" data-region=\"${img_card_region}\" data-date=\"${img_card_date}\" data-desc=\"${img_card_desc}\" target=\"_blank\">Download 4k</a> "
        ...
        public static String getImgCard(Images bingImage) {
            ...
            result = result.replace(VAR_IMG_CARD_DESC, bingImage.getDesc());
